...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        // 使用公钥、私钥对象加解密
        List<Key> keyList = RSAUtil.getRSAKeyObject(1024);
        ...
        String encryptedMsg = RSAUtil.encryptByPublicKey(message, puk);
        String decryptedMsg = RSAUtil.decryptByPrivateKey(encryptedMsg, prk);
        System.out.println("object key ! message ==  decryptedMsg ? " + message.equals(decryptedMsg));

        // 使用字符串生成公钥、私钥完成加解密
        List<String> keyStringList = RSAUtil.getRSAKeyString(1024);
        ...
        // 生成公钥、私钥
        puk = RSAUtil.getPublicKey(pukString);
        prk = RSAUtil.getPrivateKey(prkString);
        encryptedMsg = RSAUtil.encryptByPublicKey(message, puk);
        decryptedMsg = RSAUtil.decryptByPrivateKey(encryptedMsg, prk);
